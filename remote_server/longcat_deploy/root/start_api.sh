...
export LONGCAT_API_STATE_DIR="${LONGCAT_API_STATE_DIR:-${deploy_root}/api_state_lora}"
export LONGCAT_API_OUTPUT_DIR="${LONGCAT_API_OUTPUT_DIR:-${LONGCAT_API_STATE_DIR}/outputs}"
export LONGCAT_API_ENGINE=diffusers-lora
export LONGCAT_API_ADAPTER_DIR="${LONGCAT_API_ADAPTER_DIR:-/home/ma-user/work/longcat_lora/outputs/mvp_1024_r16/adapter-final}"
export LONGCAT_API_ADAPTER_REVISION="${LONGCAT_API_ADAPTER_REVISION:-01add3926eeb1cda1bbe5fcc4c6a61f6502a38cb2411633934202243c0b6898c}"
export LONGCAT_API_ADAPTER_SCALE="${LONGCAT_API_ADAPTER_SCALE:-0.8}"
export LONGCAT_API_DEVICE="${LONGCAT_API_DEVICE:-npu:0}"
export LONGCAT_API_VAE_SLICING="${LONGCAT_API_VAE_SLICING:-0}"
export LONGCAT_API_VAE_TILING="${LONGCAT_API_VAE_TILING:-0}"
export LONGCAT_API_HOST="${LONGCAT_API_HOST:-127.0.0.1}"
export LONGCAT_API_PORT="${LONGCAT_API_PORT:-8010}"
export LONGCAT_API_EXTRA_PYTHONPATH="${LONGCAT_API_EXTRA_PYTHONPATH:-/home/ma-user/work/longcat_lora/eval_python:/home/ma-user/work/longcat_lora/src/LongCat-Image}"
