...
SHARED_NEGATIVE_PROMPT = (
    ...
    "modern clothing, ordinary digital illustration, front view, cropped body, close-up, "
    ...
    "写实人物，舞台摄影，现代服饰，普通插画，正面，主体裁切，缺肢，多肢，四肢粘连，"
    "手臂贴躯干，腿部重叠，手脚遮挡，复杂背景，中央被遮挡，文字，伪文字，水印"
)

CHARACTER_SUFFIX = (
    "piying_china_style, traditional Chinese shadow-puppet leather cutout, full body strict side "
    "view, head-to-toe visible, arms and legs clearly separated from torso, visible movable joints, "
