"""Retrain with P01/P02/P05/P06, validate on P03, leave P04 unscored."""
...
parts=[[r for r in data['rows'] if r['participant'] in group] for group in [{'P01','P02','P05','P06'},{'P03'}]]
assert {r['participant'] for r in parts[0]}=={'P01','P02','P05','P06'}
